...
<section class="hero">
  ...
  <div class="kpis kpicount">
    ...
    <div class="kpi"><b>6</b><small>versões depositadas com DOI citável, carimbadas por um terceiro</small></div>
  </div>
</section>
::
...
<div class="cards" style="margin-top:22px">
  <div class="card"><h3>Depositado e citável</h3>
    <p>Seis versões com DOI próprio no Zenodo, e um DOI que cobre todas elas.
