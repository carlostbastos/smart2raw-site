...
::html
<section class="hero">
  <p class="slogan">Cinco depósitos, cada um com data de terceiro.</p>
  <h1>Citar</h1>
  ...
  <div class="kpis">
    <div class="kpi"><b>5</b><small>versões depositadas, cada uma com DOI próprio e data carimbada por um terceiro</small></div>
...
## Versão citável mais recente — 3.5.0
...
A biblioteca está hoje na **3.5.1**, uma correção de segurança sem mudança de API
nem de formato — arquivos `.s2r` da 3.5.0 e da 3.5.1 são lidos um pelo outro. O
método citável não mudou, então a referência acima continua correta; quando o
depósito da 3.5.1 aparecer, ele entra nesta tabela. O que ela corrige está na
[página de escopo técnico](/pt/escopo/).
